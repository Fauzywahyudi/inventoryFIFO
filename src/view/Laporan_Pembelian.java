...
public class Laporan_Pembelian extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbPertahun.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cbPertahunMouseClicked(evt);
            }
        });
        cbPertahun.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbPertahunActionPerformed(evt);
            }
        });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (rdSemua.isSelected()) {
            try {
                String url = "http://localhost/inventoryFIFO/laporanPembelianSemua.php";
            ...
            try {
                String url = "http://localhost/inventoryFIFO/laporanPembelianPertahun.php?tahun="+tahun;
                java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
            } catch (IOException ex) {
                Logger.getLogger(MenuPimpinan.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                String url = "http://localhost/inventoryFIFO/laporanPembelianPerbulan.php?tahun="+tahun+"&bulan="+bulan;
                java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
            } catch (IOException ex) {
                Logger.getLogger(MenuPimpinan.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void cbPertahunMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cbPertahunMouseClicked
        rdPertahun.setSelected(true);
    }//GEN-LAST:event_cbPertahunMouseClicked
    ...
    private void cbPertahunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbPertahunActionPerformed
        rdPertahun.setSelected(true);
    }//GEN-LAST:event_cbPertahunActionPerformed
