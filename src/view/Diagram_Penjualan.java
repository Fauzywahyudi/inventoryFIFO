 ...
 * @author nanda
 */
public class Diagram_Penjualan extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_Pembelian
     */
    public Diagram_Penjualan() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DIAGRAM PENJUALAN");
        jPanel1.add(jLabel1);
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(700, 0, 100, 100);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(rdPertahun.isSelected()){
            try {
                String url = "http://localhost/inventoryFIFO/diagramPertahun.php?tipe=penjualan";
            ...
            try {
                String url = "http://localhost/inventoryFIFO/diagramPerbulan.php?tahun="+tahun+"&tipe=penjualan";
                java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
            } catch (IOException ex) {
                Logger.getLogger(MenuPimpinan.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Diagram_Penjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
