...
//    }
    ...
    private void getKode() throws SQLException {
        sql = "select * from suplier ORDER BY kd_sup DESC LIMIT 1";
        Statement st = con.createStatement();
        ResultSet rs = st.executeQuery(sql);
        if (rs.next()) {
            String kd = rs.getString("kd_sup").substring(1);
            ...
            txKodeSuplier.setText("S"+No1 + no);
        } else {
            txKodeSuplier.setText("S000001");
        }
    }
...
//        throw new UnsupportedOperationException("Not yet implemented");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 0, -1, -1));
