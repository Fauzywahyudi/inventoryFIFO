...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <center>
                    <h3>LAPORAN DATA SUPLIER <br><span style="font-size: 20px;">Tanggal : <?php echo date('d/m/Y') ?></span></h3>
            ...
            <div class="col-12">
                <center>
                    <table border="1" width="100%">
                        ...
                        $sql = $kon->query("SELECT * FROM suplier ORDER BY kd_sup ASC");
